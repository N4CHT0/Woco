...
export const BlogList = [
  {
    ...
    totalComments: 89,
    totalLikes:2300,
    content: `In the ever-evolving landscape of transportation, the emergence of electric cars has sparked a revolution. Exploring the world of electric cars unveils a myriad of innovations and possibilities that are reshaping the way we perceive mobility. Electric cars, also known as electric vehicles (EVs), are automobiles powered by one or more electric motors using energy stored in rechargeable batteries. This departure from traditional internal combustion engines marks a significant shift towards sustainability and environmental consciousness. As concerns about fossil fuel depletion and climate change intensify, electric cars have emerged as a promising solution to mitigate the impact of transportation on the planet.Simply put, an electric car salary sacrifice scheme allows employees to trade a small portion of their pre-tax salary for an eco-friendly car lease. Not only do electric cars qualify for the incredibly low Benefit in Kind (BiK) rate of just 2%, but the scheme also results in significant tax savings for both the employee and employer. To ensure that as many employees across the UK benefit from the affordability an electric car salary sacrifice scheme offers, we’ve created this guide to help you choose the best EV salary sacrifice scheme for your company. When choosing benefits that are advantageous for your business and your employees, few options offer as much value (it’s completely cost-neutral for a start) as an EV salary sacrifice scheme. In a climate where economic stability and sustainability are paramount, adopting an EV scheme can bolster your corporate profile and bring innumerable gains to your team. If you're on the cusp of deciding whether or not to implement an EV salary sacrifice scheme, it's worth pausing to consider what you want to achieve. Is it primarily about giving your employees a financial leg-up in a challenging economic climate? Or are you seeking to strengthen your corporate commitment to sustainability?`,
  },
  {
    id: 2,
